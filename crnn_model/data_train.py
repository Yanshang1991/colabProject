...
if __name__ == '__main__':
    ...
    parser.add_argument('--wrdtxtfile', default = r'/content/colab/project/crnn_model/dataset/hanzi.txt', help = 'path of val data')
    parser.add_argument('--phntxtfile', default = r'/content/colab/project/crnn_model/dataset/pinyin.txt', help = 'path of val data')
    parser.add_argument('--phoneme_file', default = r'/content/colab/project/crnn_model/dataset/phoneme_label.txt', help = 'path of val data')
    parser.add_argument('--word_file', default = r'/content/colab/project/crnn_model/dataset/wrds_label.txt', help = 'path of val data')
    ...
    parser.add_argument('--pic_path', default = r'/content/colab/project/crnn_model/train_pic/', help = "path to load pics")
    # parser.add_argument('--alphabet', type=str, default='0123456789abcdefghijklmnopqrstuvwxyz')
    parser.add_argument('--expr_dir', default = r'/content/colab/project/crnn_model/expr/', help = 'Where to store samples and models')
